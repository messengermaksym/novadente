  ...
  return (
    <section id="doctors" className="py-20 lg:py-24 bg-[#f9f8f4] border-b border-[#e3e1d8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header (No AI-slop eyebrow) */}
        <motion.div
            ...
            >
              <div>
                ...
                <div className="p-5 space-y-3">
                  <div>
                    <h3 className="font-serif text-lg font-semibold text-[#0c4134] leading-snug">
                      {doctor.name}
                    </h3>
                  ...
                  <div className="pt-2 border-t border-[#e3e1d8] space-y-1.5">
                    <span className="text-[10px] font-semibold text-[#83918b] uppercase tracking-wider block">
                      Спеціалізація:
                    </span>
                    <ul className="space-y-1.5">
                      {doctor.specialties.map((spec, sIdx) => (
                        <li key={sIdx} className="text-xs text-[#515e59] leading-relaxed flex items-baseline gap-2">
              ...
              <div className="p-5 pt-0">
                <button
                  ...
                  className="w-full py-2 px-3.5 rounded-lg bg-[#f2f0ea] hover:bg-[#0c4134] text-[#0c4134] hover:text-white text-xs font-semibold transition-colors flex items-center justify-between group/btn cursor-pointer"
                >
